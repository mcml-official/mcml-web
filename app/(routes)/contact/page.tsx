  ...
  return (
    <main className="mx-auto flex max-w-6xl flex-col justify-center gap-8 px-4 py-12">
      <div className="grid gap-8 lg:grid-cols-2">
        <div className="h-[400px] overflow-hidden rounded-lg shadow-lg dark:brightness-90">
          <iframe
        ...
        <div className="bg-card text-card-foreground space-y-8 rounded-lg p-6 shadow-lg">
          <div>
